/*
  # Verificar y corregir sistema de promotores

  1. Verificar tabla de promotores
  2. Asegurar que todos los promotores estén activos
  3. Corregir función de registro de ventas
...
-- Función para verificar promotores
...
BEGIN
  ...
  SELECT array_agg(code ORDER BY code LIMIT 5) INTO sample_codes FROM promoters WHERE active = true;
