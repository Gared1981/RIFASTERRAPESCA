/*
  # Corregir sistema de liberación automática de boletos

  1. Problemas identificados
    - La función auto_cleanup_tickets no se ejecuta automáticamente
    - Falta trigger o mecanismo para ejecutar la limpieza periódicamente
    - Los boletos reservados no se liberan después de 3 horas

  2. Soluciones
    - Mejorar la función de limpieza
    - Crear función que se ejecute en cada consulta de boletos
    - Agregar limpieza automática en el frontend
    - Crear función de limpieza manual para admin
*/
