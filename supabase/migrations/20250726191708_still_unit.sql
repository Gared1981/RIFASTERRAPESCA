...
-- Función para verificar promotores (sin LIMIT en array_agg)
...
BEGIN
  ...
  -- Obtener algunos códigos de ejemplo (sin LIMIT en array_agg)
  SELECT array_agg(code) INTO sample_codes FROM (
